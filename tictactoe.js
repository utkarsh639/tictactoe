...
// logic for O
    ...
    if(index2ClassList.contains('O')){
        if(index1ClassList.contains('O') && index0ClassList.contains('O')){
            alert("O won")
        }
    }
    ...
    if(index4ClassList.contains('O')){
        if(index3ClassList.contains('O') && index5ClassList.contains('O')){
            alert("O won")
        }
    }
    
    if(index5ClassList.contains('O')){
        if(index2ClassList.contains('O') && index8ClassList.contains('O')){
            alert("O won")
        }
    }
    
    if(index5ClassList.contains('O')){
        if(index3ClassList.contains('O') && index4ClassList.contains('O')){
            alert("O won")
        }
    }
    
    if(index6ClassList.contains('O')){
        if(index3ClassList.contains('O') && index0ClassList.contains('O')){
            alert("O won")
        }
    }
    ...
    if(index6ClassList.contains('O')){
        if(index4ClassList.contains('O') && index2ClassList.contains('O')){
            alert("O won")
        }
    }
    
    if(index7ClassList.contains('O')){
        if(index6ClassList.contains('O') && index8ClassList.contains('O')){
            alert("O won")
        }
    }
    
    if(index7ClassList.contains('O')){
        if(index1ClassList.contains('O') && index4ClassList.contains('O')){
            alert("O won")
        }
    }
...
if(index2ClassList.contains('X')){
    if(index3ClassList.contains('X') && index5ClassList.contains('X')){
        alert("X won")
    }
}
...
if(index5ClassList.contains('X')){
    if(index2ClassList.contains('X') && index8ClassList.contains('X')){
        alert("X won")
    }
}
if(index5ClassList.contains('X')){
    if(index3ClassList.contains('X') && index4ClassList.contains('X')){
        alert("X won")
    }
}
if(index6ClassList.contains('X')){
    if(index0ClassList.contains('X') && index3ClassList.contains('X')){
        alert("X won")
    }
}
if(index6ClassList.contains('X')){
...
if(index6ClassList.contains('X')){
    if(index4ClassList.contains('X') && index2ClassList.contains('X')){
        alert("X won")
    }
}
if(index7ClassList.contains('X')){
    if(index6ClassList.contains('X') && index8ClassList.contains('X')){
        alert("X won")
    }
}

if(index7ClassList.contains('X')){
    if(index2ClassList.contains('X') && index4ClassList.contains('X')){
        alert("X won")
    }
}
if(index8ClassList.contains('X')){
    if(index2ClassList.contains('X') && index5ClassList.contains('X')){
        alert("X won")
    }
}
if(index8ClassList.contains('X')){
    if(index6ClassList.contains('X') && index7ClassList.contains('X')){
        alert("X won")
    }
}
if(index8ClassList.contains('X')){
